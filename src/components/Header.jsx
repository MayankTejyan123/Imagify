...
const onClickHandler = ()=>{
 ...
 >
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>Turn text to <span className='text-blue-700'
      initial={{opacity:0}}
      animate={{opacity:1}}
      ...
      >An AI text-to-image that gives you endless results in real time. With a variety of modes to choose, Flux is now available on Freepik. Try it now!</motion.p>
